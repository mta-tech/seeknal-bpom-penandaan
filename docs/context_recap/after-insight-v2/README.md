# `after-insight-v2` — domain `penandaan`
...
| Halaman | Perubahan |
|---|---|
| `50-waktu-dan-durasi.md` | enam kolom tahap timeline dan kekosongan deterministiknya |
| `85-target-capaian.md` | kolom target mana yang dipakai, grain balai × komoditi, cakupan tahun |
| `30-status-dan-alur.md` | `status_code`: blok tahap versus blok penolakan |
...
Dari 43 SQL pair yang dieksekusi: "UPT mana yang…", "urutkan", dan "berikan top" — pertanyaan peringkat mendominasi.
